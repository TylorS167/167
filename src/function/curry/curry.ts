...
export interface CurryFn {
  ...
  <A, B, C, D, E, F, G, H, I>(f: Arity8<A, B, C, D, E, F, G, H, I>): Curry8<A, B, C, D, E, F, G, H, I>
  <A, B, C, D, E, F, G, H, I, J>(f: Arity9<A, B, C, D, E, F, G, H, I, J>): Curry9<A, B, C, D, E, F, G, H, I, J>
  <A, B, C, D, E, F, G, H, I, J, K>(f: Arity10<A, B, C, D, E, F, G, H, I, J, K>): Curry10<A, B, C, D, E, F, G, H, I, J, K>
}
...
export const curry: CurryFn = function curry(fn: Function) {
  ...
  case 0: return fn
  case 1: return fn
  case 2: return curry2(fn as any)
  case 3: return curry3(fn as any)
  case 4: return curry4(fn as any)
  case 5: return curry5(fn as any)
