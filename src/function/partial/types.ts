...
export interface Arity0Partial<A> {
  (args: Array<any>): Arity0<A>
}

export interface Arity1Partial<A, B> {
  (args: [A]): Arity0<B>
  (args: [PlaceHolder]): Arity1<A, B>
  (args: Array<never>): Arity1<A, B>
}

export interface Arity2Partial<A, B, C> {
  (args: [A, B]): Arity0<C>
  (args: [A]): Arity1<B, C>
...
export interface Arity3Partial<A, B, C, D> {
  (args: [A, B, C]): Arity0<D>
  (args: [A, B]): Arity1<C, D>
  (args: [A]): Curry2<B, C, D>
...
export interface Arity4Partial<A, B, C, D, E> {
