...
export interface BindArity2 {
  ...
  <A, B, C, D, E, F, that>(f: Arity5<A, B, C, D, E, F>, obj: that): Arity5Bound<that, A, B, C, D, E, F>
  ...
  <A, B, C, D, E, F>(f: Arity5<A, B, C, D, E, F>): <that>(obj: that) => Arity5Bound<that, A, B, C, D, E, F>
